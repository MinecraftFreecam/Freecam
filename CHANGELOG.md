...
Do not edit this file manually, it is managed by [Knope](https://knope.tech).
Instead, document user-facing changes in `.changeset` files.

## 1.5.0 (2026-09-24)

### Features

#### Support for Minecraft 26.3 (#528)

Note: This is experimental support that has only had light testing. Feedback and [bug reports](https://github.com/MinecraftFreecam/Freecam/issues) are greatly appreciated!

By Matt Sturgeon

### Fixes

- **Various translation updates** by Crowdin Bot (#613)

#### The required MixinExtras version is now included with Freecam (#636)

This resolves [issues](https://github.com/MinecraftFreecam/Freecam/issues/629) stemming from runtime version discrepancies,
and also improves compatibility with older fabric-loader, Forge, and NeoForge versions.

By Matt Sturgeon

## 1.5.0-alpha.2 (2026-09-23)
...
#### Tripod key combos not working in 26.3 (#627)
...
## 1.5.0-alpha.0 (2026-09-15)

### Features

#### Support for Minecraft 26.3 (8ff2ee6)
...
1.4.1 adds support for Minecraft 26.2, a new 'Outline Player' feature, and various minor improvements.
...
- Cloth Config is now bundled on all builds, including Forge 1.17.1 ([539](https://github.com/MinecraftFreecam/Freecam/pull/539), [561](https://github.com/MinecraftFreecam/Freecam/pull/561))
  - It is now part of the main mod, rather than a nested child mod
  - This also resolves Fabric Loader "invalid version" warnings related to our Cloth Config implementation ([486](https://github.com/MinecraftFreecam/Freecam/issues/486), [534](https://github.com/MinecraftFreecam/Freecam/pull/534))
...
- Restored legacy Forge compatibility, broken in 1.4.0 ([516](https://github.com/MinecraftFreecam/Freecam/issues/516), [526](https://github.com/MinecraftFreecam/Freecam/pull/526))
