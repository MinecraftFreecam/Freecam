    ...
    static void apply(GuiRegistry registry) {
        ...
        registry.registerAnnotationProvider(
                (i18n, field, config, defaults, guiProvider) -> {
                    ...
                    return Collections.singletonList(new DoubleSliderEntry(new TranslatableComponent(i18n), bounds.precision(), bounds.min(), bounds.max(), value, RESET_TEXT, defaultValue, save));
                },
