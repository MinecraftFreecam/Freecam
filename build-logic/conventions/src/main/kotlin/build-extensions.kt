...
val Project.commonExpansions: Map<String, String>
    get() = mapOf(
        ...
        "neoforgeLoaderReq" to meta.properties["neoforge_loader_req"],
        "neoforgeReq" to meta.properties["neoforge_req"],
        "neoforgeMcReq" to meta.properties["neoforge_mc_req"],
        "forgeVersion" to meta.deps["forge_version"],
        "forgeLoaderReq" to meta.properties["forge_loader_req"],
        "forgeReq" to meta.properties["forge_req"],
        "forgeMcReq" to meta.properties["forge_mc_req"],
        "clothConfigReq" to meta.properties["cloth_config_req"],
